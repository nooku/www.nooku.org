...
<body>
    ...
    <div class="container">
        <div class="span12">
            ...
            <p class="lead">By drastically reducing the amount of code you need to write, Nooku helps you to create powerful web applications easily. Using the web technologies you know and love: PHP, HTML, CSS, and JavaScript.</p>
            <p class="lead">Nooku is a free and open source toolkit that allows you to create applications quickly. The intuitive API, design pattern based architecture, and out-of-the-box security, leave you more time to focus on features.</p>
        </div>
    </div>
